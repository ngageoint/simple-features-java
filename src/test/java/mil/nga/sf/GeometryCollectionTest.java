...
public class GeometryCollectionTest {
	...
	public void testMultiPoint() throws IOException {
		...
		for (int i = 0; i < 5; i++) {
			points.add(SFTestUtils.createPoint(SFTestUtils.coinFlip(),
	...
	public void testMultiPolygon() throws IOException {
		...
		for (int i = 0; i < 5; i++) {
			polygons.add(SFTestUtils.createPolygon(SFTestUtils.coinFlip(),
					SFTestUtils.coinFlip()));
		}
	...
	public void testMultiCurve() throws IOException {
		...
		for (int i = 0; i < 5; i++) {
			if (i % 2 == 0) {
				curves.add(SFTestUtils.createCompoundCurve(
						SFTestUtils.coinFlip(), SFTestUtils.coinFlip()));
			} else {
				curves.add(SFTestUtils.createLineString(SFTestUtils.coinFlip(),
						SFTestUtils.coinFlip()));
			}
		}
	...
	public void testMultiSurface() throws IOException {
		...
		for (int i = 0; i < 5; i++) {
			if (i % 2 == 0) {
				surfaces.add(SFTestUtils.createCurvePolygon(
						SFTestUtils.coinFlip(), SFTestUtils.coinFlip()));
			} else {
				surfaces.add(SFTestUtils.createPolygon(SFTestUtils.coinFlip(),
						SFTestUtils.coinFlip()));
			}
		}
